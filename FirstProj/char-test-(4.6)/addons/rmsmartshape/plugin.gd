...
func _debug_mouse_positions(mm: InputEventMouseMotion, t: Transform2D) -> void:
	print_debug("========================================")
	print_debug("MouseDelta:%s" % str(_mouse_motion_delta_starting_pos))
	print_debug("= MousePositions =")
	print_debug("Position:  %s" % str(mm.position))
	print_debug("Relative:  %s" % str(mm.relative))
	print_debug("= Transforms =")
	print_debug("Transform3D: %s" % str(t))
	print_debug("Inverse:   %s" % str(t.affine_inverse()))
	print_debug("= Transformed Mouse positions =")
	print_debug("Position:  %s" % str(t.affine_inverse() * mm.position))
	print_debug("Relative:  %s" % str(t.affine_inverse() * mm.relative))
	print_debug("MouseDelta:%s" % str(t.affine_inverse() * _mouse_motion_delta_starting_pos))
